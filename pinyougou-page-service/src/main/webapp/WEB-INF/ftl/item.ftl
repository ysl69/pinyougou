    ...
    <div id="item">
        <div class="crumb-wrap">
            <ul class="sui-breadcrumb">
                <li><a href="#">${tbItemCat1}</a></li>
                <li><a href="#">${tbItemCat2}</a></li>
                <li><a href="#">${tbItemCat3}</a></li>
            </ul>
        </div>
        <!--product-info-->
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="cart.html" @click="addGoodsToCart()"  class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
